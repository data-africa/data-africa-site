...
const url = "api/join/?show=geo&geo=<geoid>&sumlevel=all&required=start_year,cropland_rainfallCVgt20pct_pct,rainfall_awa_mm,cropland_total_ha&display_names=1";
  ...
  render() {
    ...
    return (
      ...
      <SectionRows>
        ...
        <SectionColumns ref={ comp => this.viz = comp }>
